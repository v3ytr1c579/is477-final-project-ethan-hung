...
The dataset files used in this project are hosted externally on Box due to GitHub file size limits. After downloading, they should be placed in the `data/` folder before running the notebook.
...
The dataset files exceed GitHub’s size limits and are hosted externally on Box:

https://uofi.box.com/s/1pg8sd0nxtfkzz02d67o2e0g5fj29fsr

Download the following files and place them in the `data/` folder before running the notebook:

- Traffic_Crashes_-_Crashes_20260428.csv  
- Traffic_Crashes_-_People_20260428.csv  

To reproduce the analysis and results in this project, follow the steps below:
...
4. Ensure the dataset files are placed in the data/ folder with the exact filenames used in the notebook:
   Traffic_Crashes_-_Crashes_20260428.csv  
   Traffic_Crashes_-_People_20260428.csv  
...
6. Run all cells from top to bottom. The notebook follows this workflow:
   - Data loading  
   - Data inspection  
   - Data integration (merging datasets using CRASH_RECORD_ID)  
   - Data quality assessment  
   - Data cleaning (dropping high-missing columns and filtering UNKNOWN weather values)  
   - Exploratory data analysis  
   - Visualization  

7. After running all cells, the final visualization will be generated and saved in the outputs/ folder as:
   injury_by_person_type.png

This project was developed in a Jupyter Notebook environment using pandas 2.1.4, matplotlib 3.8.2, jupyter 1.1.1, notebook 7.3.2, and ipykernel 6.29.0.

Alternatively, the full analysis can be reproduced by executing the provided run_analysis.sh script, which runs the Jupyter notebook non-interactively using nbconvert and regenerates all outputs from raw data.
